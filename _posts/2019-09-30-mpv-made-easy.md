...
`screenshot-format` sets the format. It is highly recommended that you set this to `png`. By default it's set to `jpeg`, which heavily compresses the image. png, in the meantime, is a lossless format.
