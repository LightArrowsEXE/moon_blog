...
date:   2020-08-04
excerpt: "a.k.a. \"this looks good, let's do that\""
tag:
- Anime
- Fansubbing
comments: true
...
Occasionally you will have characters making "hesitating noises". For example, "Uh...", "Ah...", "Uhm..." or stutters. These can often be omitted, but in sometimes it may be preferable to keep them. No matter what you do, it's a good idea to let your timer know, or if you can time yourself, to retime the lines to make sure it also includes it.

For stutters, always capitalise the first letter if the stutter is at the start of the sentence, and make sure you repeat the initial sound. In practise this basically means you only repeat an additional "h" if present.
...
If a sentence reads awkwardly, rewrite it to retain the original meaning or point the sentence was meant to get across, while ensuring the sentence flows more naturally. This isn't limited to single lines, either. If lines can be reasonably reordered to sound better, that should also be under consideration.
...
From my experience, in Japanese you hear names far more often than in English. You don't need to write the name every single time it's said in the Japanese dialogue, often a simple "you", "he", "they", etc. will suffice and come off more naturally.
...
Similarly, it's a good idea to get rid of Crunchyroll's linebreaks, as they actively get in the way while editing. A simple Find & Replace will usually suffice, or you can use a script called "Script Cleanup".
